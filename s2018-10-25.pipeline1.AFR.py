...
#-------------------------------------
# Inputs
diploid_afr_sample_size = int(sys.argv[1])
...
afr_sample_size = diploid_afr_sample_size*2 # number of haploid alleles to be simulated; true sample size is afr_sample_size/2
...
def out_of_africa(afr_sample_size):
    ...
    population_configurations = [
        ...
        msprime.PopulationConfiguration(
            sample_size=afr_sample_size, initial_size=N_AF, growth_rate=r_AFR_exp),
        # European population has size N_EUR and growth rate r_EUR_exponential
        msprime.PopulationConfiguration(
            sample_size=0, initial_size=N_EU, growth_rate=r_EU_exp),
...
tree_sequence=out_of_africa(afr_sample_size)
end_time=time.time()
